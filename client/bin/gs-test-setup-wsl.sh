...
GCI_LIBRARY_PATH="${3:?$USAGE_MESSAGE}"
GEMSTONE_GLOBAL_DIR="${4:?$USAGE_MESSAGE}"
...
su gsuser -c "cd '$work_dir' && '$SCRIPT_DIR/gs-test-setup.sh' '$VERSION' '$NAME' --remote --gci-library-path '$GCI_LIBRARY_PATH' --global-dir '$GEMSTONE_GLOBAL_DIR'"
