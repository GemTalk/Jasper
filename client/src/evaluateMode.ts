 ...
 * drift apart in what a gesture means: Display It shows the printString, Execute It runs it for its
 * effect without printing an answer, and Inspect It opens the answer in an Inspector. They are named
