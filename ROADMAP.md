...
- **[Browser convergence](https://github.com/GemTalk/Jasper/issues/260)** *(already in flight)* — one shared backend for the System Browser and the GemStone Explorer, dogfooding the Explorer ([#266](https://github.com/GemTalk/Jasper/issues/266)) and fixing the refresh/Unicode bugs ([#237](https://github.com/GemTalk/Jasper/issues/237), [#249](https://github.com/GemTalk/Jasper/issues/249), [#235](https://github.com/GemTalk/Jasper/issues/235)). *Essential.*
...
- **[Code history](https://github.com/GemTalk/Jasper/issues/253)** — method-level versions with display, diff, and edit ([#253](https://github.com/GemTalk/Jasper/issues/253)) plus a class version browser ([#255](https://github.com/GemTalk/Jasper/issues/255)). *Expected.*
- **[LSP completeness](https://github.com/GemTalk/Jasper/issues/231)** — implement Rename Symbol and align the three language modes. *Expected.*

### Later

- **Object Log / continuation (post-mortem) debugging** — no tracking issue yet. *Expected.*
- **Multi-user awareness** — see other sessions' commits, "view is stale", last-changed-by; no tracking issue yet. *Differentiating.*
- **Code critics / lint** — no tracking issue yet. *Expected.*
- **[Refactoring canon completion](https://github.com/GemTalk/Jasper/issues/252)** — add/remove parameter, push up/pull down, safe-delete, plus RB engine version management ([#269](https://github.com/GemTalk/Jasper/issues/269), [#270](https://github.com/GemTalk/Jasper/issues/270)). *Expected.*
- **[Traits support](https://github.com/GemTalk/Jasper/issues/258)** and **[undoable IDE actions](https://github.com/GemTalk/Jasper/issues/174)**. *Differentiating.*
...
- **[Config viewer/editor](https://github.com/GemTalk/Jasper/issues/232)** and **[inline process management](https://github.com/GemTalk/Jasper/issues/234)** — round out day-to-day stone care, including the temp-obj-space warning ([#230](https://github.com/GemTalk/Jasper/issues/230)) and a one-click Topaz console. *Expected.*
...
- **Headless CLI** over the same admin operations — no tracking issue yet. *Expected.*
- **Dashboards/alerting, verified backup automation, container stones** — no tracking issues yet. *Differentiating.*

## Project & Package Management

### Now

- **[Rowan reliability](https://github.com/GemTalk/Jasper/issues/264)** — fix the diff ([#264](https://github.com/GemTalk/Jasper/issues/264)) and unload ([#265](https://github.com/GemTalk/Jasper/issues/265)) failure paths. *Essential.*
...
- **Method-level merge UI** and **branch-per-task workflow** — no tracking issues yet. *Expected.*
