...
- [Auto-commit](explanation/auto-commit.md) — where the commit hook goes and why not at the GCI round trip or the refactoring apply; why a committed change is still undoable but no longer abortable.
