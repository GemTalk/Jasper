...
doit
| cls |
cls := Object subclass: 'GsMethodHistory'
  instVarNames: #()
  classVars: #()
  classInstVars: #()
  poolDictionaries: #()
...
removeallmethods GsMethodHistory
removeallclassmethods GsMethodHistory
