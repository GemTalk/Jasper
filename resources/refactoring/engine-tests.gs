...
doit
| cls |
cls := TestCase subclass: 'GsMethodHistoryTest'
  instVarNames: #()
  classVars: #()
  classInstVars: #()
  poolDictionaries: #()
...
removeallmethods GsMethodHistoryTest
removeallclassmethods GsMethodHistoryTest
...
category: 'tests - apply'
method: GsInstVarRefactoringTest
testApplyCompilesAccessorsInTheSameApply
...
category: 'tests - apply'
method: GsInstVarRefactoringTest
testApplyReportsAnAccessorThatCannotCompileAndInstallsNothing
...
category: 'tests'
method: GsMethodHistoryTest
testRecordsVersionsWithTimeStampAndAuthor
	| json |
...
category: 'tests'
method: GsMethodHistoryTest
testFirstEditSeedsTheOriginalVersion
	| json |
	self edit: 'm1 ^2' in: self fixture.
	json := GsMethodHistory forClassNamed: 'GsMHFixture' selector: 'm1' meta: false.
...
category: 'tests'
method: GsMethodHistoryTest
testIdenticalSourceIsNotRecordedTwice
	| json |
	self edit: 'm1 ^2' in: self fixture.
	self edit: 'm1 ^2' in: self fixture.
	json := GsMethodHistory forClassNamed: 'GsMHFixture' selector: 'm1' meta: false.
...
category: 'tests'
method: GsMethodHistoryTest
testNewMethodStartsFromItsFirstCompile
	| json |
...
category: 'tests'
method: GsMethodHistoryTest
testInstalledMethodNotInHistoryShowsSyntheticCurrent
	| json |
...
category: 'tests'
method: GsMethodHistoryTest
testRestoringAnOldVersionRecordsANewVersion
	| json |
	self edit: 'm1 ^2' in: self fixture.
...
category: 'tests'
method: GsMethodHistoryTest
testInstanceAndClassSidesAreSeparate
	self edit: 'm1 ^2' in: self fixture.
...
category: 'tests'
method: GsMethodHistoryTest
testRemoveHistoryForgetsTheVersions
	| json |
	self edit: 'm1 ^2' in: self fixture.
...
category: 'tests'
method: GsRefactoringEnvironmentTest
testDictionaryScopeCheckSkipsAnAnonymousDictionary
