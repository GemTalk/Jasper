...
category: 'tests - json'
method: GsInstVarRefactoringTest
testOutOfScopeJsonCarriesOptionsAndCommitNote
	| refactoring json |
	refactoring := self remove: 'count'.
